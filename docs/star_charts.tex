...
approximate formula. 
\beq
  m = -12.778 + 1.876 \phi - 0.55025 \phi^2 + 0.27093 \phi^3 
+ 5\log_{10} (D/384400~{\rm km}) ,
\eeq
where $\phi$ is the phase angle in radians and $D$ is the distance of the Moon. 
...
The formula fits the data to within 0.2 magnitude.
